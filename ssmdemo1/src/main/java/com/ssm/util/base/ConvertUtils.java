...
public class ConvertUtils {
    ...
    public static int strToInt(String str, int defaultValue) {
        try {
            ...
            //System.err.println("ConvertUtils->strToInt->Exception");
        }
        return defaultValue;
    }
    ...
    public static long strToLong(String str, long defaultValue) {
        try {
            ...
            //System.err.println("ConvertUtils->strToLong->Exception");
        }
        return defaultValue;
    }
    ...
    public static float strToFloat(String str, float defaultValue) {
        try {
            ...
            //System.err.println("ConvertUtils->strToFloat->Exception");
        }
        return defaultValue;
    }
    ...
    public static double strToDouble(String str, double defaultValue) {
        try {
            ...
            //System.err.println("ConvertUtils->strToDouble->Exception");
        }
        return defaultValue;
    }
    ...
    public static java.util.Date strToDate(String str, String format, java.util.Date defaultValue) {
        ...
        try {
            ...
            //System.err.println("ConvertUtils->strToDate->parseException");
        }
        return defaultValue;
    }
